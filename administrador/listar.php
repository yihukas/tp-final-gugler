			...
			<table>
				...
				<tr>
					...
					<td class="text-center">
						<a href="/tp6/administrador/editar.php?id=<?= htmlentities($fila->idusuario) ?>" title="Editar"><img alt="Modificar" src="/tp6/includes/img/edit.png"></a>
						<a href="/tp6/administrador/eliminar.php?id=<?= htmlentities($fila->idusuario) ?>" title="Eliminar"><img alt="Eliminar" src="/tp6/includes/img/delete.png"></a>
					</td>
				</tr>
				<?php } ?>
